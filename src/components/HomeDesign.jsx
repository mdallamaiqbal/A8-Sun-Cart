    ...
    return (
        <div className="container mx-auto">
            <div className='flex flex-col-reverse md:flex-row gap-3 justify-between items-center mt-10 md:mt-20 max-w-7xl mx-auto '>
                <div>
                    <h3 className='text-3xl lg:text-5xl text-center md:text-start text-[#34B0BD] leading-tight font-extrabold'>Summer Sale <br /> <span className='ml-5 text-[#F09633] text-4xl lg:text-7xl animate-pulse '>50%</span> OFF</h3>
